...
public class GameFragment extends Fragment {
    ...
    int tempNum;
    View view;
    public static GameFragment newInstance(int difficulty, int points) {
